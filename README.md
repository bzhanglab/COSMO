...
<details>
  ...
  * `cosmo_final_result.tsv` table of corrected labels. Any inconsistency of id in the same row indicates the presence of mislabeling error. The table is generated using prediction results from both method_1 and method_2.
