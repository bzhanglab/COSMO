...
def run(pro_file:str, rna_file:str, sample_file:str, out_dir="./", prefix="test"):
...
def main():
    ...
    parser.add_argument('-s', '--sample_file', default=None, type=str,
                       help="RNA expression data")
    ...
    run(pro_file=pro_file,rna_file=rna_file,sample_file=sample_file,out_dir=out_dir)
